...
class DetailCategoryWidget extends StatefulWidget {
  ...
  DetailCategoryWidget(this.id, this.title);

  @override
  _DetailCategoryWidgetState createState() => _DetailCategoryWidgetState();
}
...
class _DetailCategoryWidgetState extends State<DetailCategoryWidget> {
  ...
  void didChangeDependencies() {
    ...
    _appBloc.getPost(widget.id, TypePost.CATEGORY).then((value) {
      if (value != null) {
        setState(() {
          datas = value;
        });
